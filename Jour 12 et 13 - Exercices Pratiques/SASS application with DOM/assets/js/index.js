...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  buttonHelpDOM.addEventListener("click", function (event) {
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  buttonCloseDOM.addEventListener("click", function (event) {
    let popUpDOM = document.querySelector(".popup-help");
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  buttonMenuDOM.addEventListener("click", function (event) {
    let menuDOM = document.querySelector("left-panel");
    menuDOM.classList.toggle("visible");
  });
});
